...

{
    ...
    class Employee implements People {
        constructor(public name: String, public age: number, public extra: String) { // this is feature of typescript where we can initialize class variables like these short hand way.
        }
    ...
    const user = new Employee("kaka",19,"Bablu");
    console.log(user.name, user.age, user.extra);
    console.log(user.greet());
}